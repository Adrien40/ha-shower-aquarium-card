...
`;var zt={label_consumed:"Consomm\xE9",label_remaining:"Restant",label_target:"Objectif",label_temperature:"Temp\xE9rature",field_entity:"Entit\xE9 de volume de douche",field_temp_entity:"Entit\xE9 temp\xE9rature de l'eau (optionnel)",field_title:"Titre de la carte (laisser vide pour masquer)",theme_freshwater:"Eau douce (Tropical)",theme_saltwater:"Eau de mer (R\xE9cif)",theme_coldwater:"Eau froide (Poissons rouges)",field_theme:"Biotope de l'aquarium",field_fish_count:"Nombre de poissons",field_target_budget_entity:"Entit\xE9 d'objectif (volume d'eau max)",field_target_budget:"Objectif de la douche (L)",field_survival_volume:"Volume de survie des animaux",field_temp_boil:"Seuil d'\xE9bullition (\xB0C)",field_temp_deadly:"Seuil mortel de temp\xE9rature (\xB0C)",field_algae_enabled:"Activer l'accumulation d'algues",field_algae_delay:"D\xE9lai d'apparition des algues (heures)",field_algae_age:"\xC2ge des algues",field_fish_speed:"Vitesse des poissons",field_fullscreen:"Mode plein \xE9cran",helper_fullscreen:"Tablette, Nest Hub...",field_aspect_ratio_width:"Ratio - Largeur (ex : 1024, 16, 4)",field_aspect_ratio_height:"Ratio - Hauteur (ex : 600, 9, 3)",label_cost:"Co\xFBt",field_night_entity:"Entit\xE9 du mode nuit (optionnel)",helper_night_entity:"sun.sun (nuit = sous l'horizon), un capteur binaire / bool\xE9en (on = nuit) ou un capteur de luminosit\xE9",field_night_lux:"Seuil de luminosit\xE9 nuit (lx)",field_show_cost:"Afficher le co\xFBt estim\xE9 de la douche",helper_show_cost:"Eau + \xE9nergie de chauffe, estim\xE9s d'apr\xE8s le volume et la temp\xE9rature",field_water_price:"Prix de l'eau (\u20AC/m\xB3)",field_energy_price:"Prix de l'\xE9nergie (\u20AC/kWh)",field_cold_water_temp:"Temp\xE9rature de l'eau froide (\xB0C)",field_animation_quality:"Qualit\xE9 d'animation",quality_max:"Maximale",quality_balanced:"\xC9quilibr\xE9e",quality_light:"L\xE9g\xE8re (Google Nest Hub)",helper_animation_quality:"L\xE9g\xE8re : 20 images/s et effets simplifi\xE9s, pour les \xE9crans peu puissants"};var Xt={label_consumed:"Consumed",label_remaining:"Remaining",label_target:"Target",label_temperature:"Temperature",field_entity:"Shower volume entity",field_temp_entity:"Water temperature entity (optional)",field_title:"Card title (leave empty to hide)",theme_freshwater:"Freshwater (Tropical)",theme_saltwater:"Saltwater (Reef)",theme_coldwater:"Coldwater (Goldfish)",field_theme:"Aquarium biotope",field_fish_count:"Number of fishes",field_target_budget_entity:"Target entity (max water volume)",field_target_budget:"Shower target budget (L)",field_survival_volume:"Survival volume for animals",field_temp_boil:"Boiling temperature threshold (\xB0C)",field_temp_deadly:"Deadly temperature threshold (\xB0C)",field_algae_enabled:"Enable dirty algae accumulation",field_algae_delay:"Algae accumulation delay (hours)",field_algae_age:"Algae age",field_fish_speed:"Fish speed",field_fullscreen:"Fullscreen mode",helper_fullscreen:"Tablet, Nest Hub...",field_aspect_ratio_width:"Ratio - Width (e.g. 1024, 16, 4)",field_aspect_ratio_height:"Ratio - Height (e.g. 600, 9, 3)",label_cost:"Cost",field_night_entity:"Night mode entity (optional)",helper_night_entity:"sun.sun (night = below horizon), a binary sensor / boolean (on = night) or an illuminance sensor",field_night_lux:"Night illuminance threshold (lx)",field_show_cost:"Show estimated shower cost",helper_show_cost:"Water + heating energy, estimated from volume and temperature",field_water_price:"Water price (\u20AC/m\xB3)",field_energy_price:"Energy price (\u20AC/kWh)",field_cold_water_temp:"Cold water temperature (\xB0C)",field_animation_quality:"Animation quality",quality_max:"Maximum",quality_balanced:"Balanced",quality_light:"Light (Google Nest Hub)",helper_animation_quality:"Light: 20 frames/s and simpler effects, for low-power screens"};var $t={fr:zt,en:Xt};function V(s){return(s?.locale?.language||s?.language||"en").substring(0,2).toLowerCase()}function Be(s){return $t[s]||$t.en}function C(s,t){return Be(s)[t]||$t.en[t]||t}var Ie=[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",selector:{entity:{domain:"sensor"}}},{name:"title",selector:{text:{}}},{name:"theme",default:"freshwater",selector:{select:{options:[{value:"freshwater",label:"Eau douce (Tropical)"},{value:"saltwater",label:"Eau de mer (R\xE9cif)"},{value:"coldwater",label:"Eau froide (Poissons rouges)"}]}}},{name:"fish_count",default:4,selector:{number:{min:1,max:10,mode:"slider"}}},{name:"target_budget_entity",selector:{entity:{domain:["input_number","number","sensor"]}}},{name:"target_budget",default:50,selector:{number:{min:1,max:500,unit_of_measurement:"L",mode:"box"}}},{name:"survival_volume",default:10,selector:{number:{min:1,max:100,unit_of_measurement:"L",mode:"box"}}},{name:"temp_boiling_threshold",default:40,selector:{number:{min:25,max:60,unit_of_measurement:"\xB0C",mode:"box"}}},{name:"temp_deadly_threshold",default:45,selector:{number:{min:30,max:70,unit_of_measurement:"\xB0C",mode:"box"}}},{name:"algae_enabled",default:!0,selector:{boolean:{}}},{name:"algae_delay_hours",default:12,selector:{number:{min:1,max:48,unit_of_measurement:"h",mode:"box"}}},{name:"algae_age",default:0,selector:{number:{min:0,max:48,unit_of_measurement:"h",mode:"slider"}}},{name:"fish_speed_multiplier",default:1.2,selector:{number:{min:.2,max:3,step:.1,mode:"slider"}}},{name:"night_entity",selector:{entity:{domain:["sun","sensor","binary_sensor","input_boolean"]}}},{name:"night_lux_threshold",default:20,selector:{number:{min:1,max:1e3,unit_of_measurement:"lx",mode:"box"}}},{name:"show_cost",default:!1,selector:{boolean:{}}},{name:"water_price_per_m3",default:4.5,selector:{number:{min:0,max:30,step:.01,unit_of_measurement:"\u20AC/m\xB3",mode:"box"}}},{name:"energy_price_per_kwh",default:.25,selector:{number:{min:0,max:2,step:.001,unit_of_measurement:"\u20AC/kWh",mode:"box"}}},{name:"cold_water_temp",default:15,selector:{number:{min:0,max:30,unit_of_measurement:"\xB0C",mode:"box"}}},{name:"animation_quality",default:"max",selector:{select:{options:[{value:"max",label:"Maximale"},{value:"balanced",label:"\xC9quilibr\xE9e"},{value:"light",label:"L\xE9g\xE8re (Google Nest Hub)"}]}}},{name:"fullscreen",default:!1,selector:{boolean:{}}},{name:"aspect_ratio_width",default:1024,selector:{number:{min:1,max:4e3,mode:"box"}}},{name:"aspect_ratio_height",default:600,selector:{number:{min:1,max:4e3,mode:"box"}}}],Qe={entity:"field_entity",temperature_entity:"field_temp_entity",title:"field_title",theme:"field_theme",fish_count:"field_fish_count",target_budget_entity:"field_target_budget_entity",target_budget:"field_target_budget",survival_volume:"field_survival_volume",temp_boiling_threshold:"field_temp_boil",temp_deadly_threshold:"field_temp_deadly",algae_enabled:"field_algae_enabled",algae_delay_hours:"field_algae_delay",algae_age:"field_algae_age",fish_speed_multiplier:"field_fish_speed",night_entity:"field_night_entity",night_lux_threshold:"field_night_lux",show_cost:"field_show_cost",water_price_per_m3:"field_water_price",energy_price_per_kwh:"field_energy_price",cold_water_temp:"field_cold_water_temp",animation_quality:"field_animation_quality",fullscreen:"field_fullscreen",aspect_ratio_width:"field_aspect_ratio_width",aspect_ratio_height:"field_aspect_ratio_height"},bt=class extends E{static get properties(){return{hass:{type:Object},_config:{type:Object}}}setConfig(t){this._config={...t}}_lang(){return V(this.hass)}_computeLabel(t){let e=Qe[t.name];return e?C(this._lang(),e):t.name}_computeHelper(t){let e=this._lang();switch(t.name){case"fullscreen":return C(e,"helper_fullscreen");case"night_entity":return C(e,"helper_night_entity");case"show_cost":return C(e,"helper_show_cost");case"animation_quality":return C(e,"helper_animation_quality");default:return""}}_valueChanged(t){if(!this._config||!this.hass)return;let e={...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}_schema(){let t=this._lang();return Ie.map(e=>e.name==="animation_quality"?{...e,selector:{select:{options:[{value:"max",label:C(t,"quality_max")},{value:"balanced",label:C(t,"quality_balanced")},{value:"light",label:C(t,"quality_light")}]}}}:e)}render(){return!this.hass||!this._config?S``:S`
      ...
      ></ha-form>
    `}};customElements.get("shower-aquarium-card-editor")||customElements.define("shower-aquarium-card-editor",bt);var Yt={freshwater:{waterTop:"#38bdf8",waterBottom:"#0284c7",sandColor:"#fde68a",background:"#f0fdfa",palette:["#3b82f6","#ef4444","#10b981","#f59e0b","#8b5cf6","#ec4899","#06b6d4","#f97316","#14b8a6","#84cc16"]},saltwater:{waterTop:"#06b6d4",waterBottom:"#0e7490",sandColor:"#fef08a",background:"#ecfeff",palette:["#f97316","#eab308","#3b82f6","#a855f7","#ec4899","#14b8a6","#06b6d4","#f43f5e","#84cc16","#6366f1"]},coldwater:{waterTop:"#67e8f9",waterBottom:"#0891b2",sandColor:"#cbd5e1",background:"#f8fafc",palette:["#ea580c","#f97316","#fb923c","#fdba74","#fbbf24","#d97706","#b45309","#78350f","#ffffff","#94a3b8"]}};function wt(s){return Yt[s]||Yt.freshwater}function Jt(s){let t=Number(s?.aspect_ratio_width)||1024,e=Number(s?.aspect_ratio_height)||600;return Math.max(400,Math.min(2048,Math.round(1024*(e/t))))}function te(s,t){let e={consumedVolume:0,hoursSinceLastShower:0,temperature:0,targetBudget:Number(t?.target_budget)||50,survivalVolume:Number(t?.survival_volume)||10};if(!s||!t)return e;if(t.entity&&s.states[t.entity]){let r=s.states[t.entity],i=parseFloat(r.state);if(e.consumedVolume=isNaN(i)?0:Math.max(0,i),r.last_changed){let o=new Date(r.last_changed).getTime();e.hoursSinceLastShower=Math.max(0,(Date.now()-o)/(1e3*60*60))}}if(t.temperature_entity&&s.states[t.temperature_entity]){let r=parseFloat(s.states[t.temperature_entity].state);e.temperature=isNaN(r)?0:r}if(t.target_budget_entity&&s.states[t.target_budget_entity]){let r=parseFloat(s.states[t.target_budget_entity].state);isNaN(r)||(e.targetBudget=r)}return e}function Ve(s,t){return t==="saltwater"?s<2?0:s===2?1:s===3?3:2:t==="coldwater"?s%3:s%4}var st=[1.35,1.65,1.2,1.85,1.45,1.6,1.25,1.75,1.3,1.5];function vt(s,t){let e=wt(t),r=Math.min(10,Math.max(1,Number(s)||4));return Array.from({length:r},(i,o)=>{let n=Ve(o,t),c=t==="saltwater"&&n===0,l=1.38-(st[o%st.length]-1.2)*.2,f=Math.random()*50-25,h=Math.random()*50-25;return{species:n,color:e.palette[o%e.palette.length],scale:st[o%st.length],phase:Math.random()*6.28,x:c?190+o*140:120+o*760/Math.max(1,r-1)+f,y:c?470:160+o%3*90+h,vx:l*(.8+Math.random()*.4),vy:.45*(Math.random()<.5?1:-1)*(.7+Math.random()*.5),dir:Math.random()<.5?1:-1,deathProgress:0}})}function ot({config:s,metrics:t,canvasHeight:e}){let r=t.targetBudget,i=t.survivalVolume,o=r+i,n=t.consumedVolume,c=t.temperature,l=Number(s?.temp_boiling_threshold)||40,f=Number(s?.temp_deadly_threshold)||45,h=Math.max(0,o-n),p=o>0?Math.max(0,Math.min(1,h/o)):0,u=!!s?.fullscreen,m=u?0:15,g=u?600:e-35,w=g-m,_=g-p*w,v=c>=f&&c>0,M=h<=0,k=v||M,L=c>=l&&c>0,a=n>r&&!k,$=n>r*.7&&!a&&!k,x=Number(s?.fish_speed_multiplier)||1.2,B=((a||L)&&!k?2:1)*x;return{targetBudget:r,survivalVolume:i,totalVolume:o,currentVolume:n,currentTemp:c,boilTemp:l,deadlyTemp:f,remainingVolumeInTank:h,waterRatio:p,tankTop:m,tankBottom:g,tankHeight:w,waterSurfaceY:_,isHeatDead:v,isWaterDead:M,isDead:k,isBoiling:L,isCritical:a,isWarning:$,speedMultiplier:B}}function ee({currentTemp:s,currentVolume:t,targetBudget:e,deadlyTemp:r,boilTemp:i}){let o=Math.max(0,Math.min(1,s/45)),n=s>=r?"#ef4444":s>=i?"#f97316":s>=38?"#f59e0b":"#0284c7",c=Math.max(0,Math.min(1,t/Math.max(1,e))),l=t>e?"#ef4444":t>e*.7?"#f59e0b":"#0284c7";return{tempFraction:o,tempColor:n,volFraction:c,volColor:l}}var ie=8e3,kt=7e3,Mt=900;function at(){return{lastVolume:null,lastIncreaseAt:0,target:0,showerActive:!1}}function re(s,t,e){if(s.lastVolume===null)return{...s,lastVolume:t};if(t<s.lastVolume-1e-6)return{...at(),lastVolume:t};if(t>s.lastVolume+1e-6){let r=t-s.lastVolume,i=(e-s.lastIncreaseAt)/1e3,n=s.lastIncreaseAt>0&&i>.2&&i<=15?r/(i/60):null,c=n===null?.5:Math.max(.25,Math.min(1,n/10));return{lastVolume:t,lastIncreaseAt:e,target:c,showerActive:!0}}return s}function se(s,t){return s.lastIncreaseAt&&t-s.lastIncreaseAt<ie?s.target:0}function oe(s,t){return s.showerActive&&s.lastIncreaseAt>0&&t-s.lastIncreaseAt>=ie}function ae(s,t,e){return!e&&s>0&&s<=t}function ne(s,t=36){return s>.02?Math.min(t,Math.round(4+s*(t-4))):0}function le(s,t,e=45){return s<=t+e?"feed":"knock"}function ce(s,t,e,r,i=280,o=Math.random){let n=s-e,c=t-r,l=Math.hypot(n,c);if(l>i)return null;let f,h;if(l<1){let m=o()*Math.PI*2;f=Math.cos(m),h=Math.sin(m)}else f=n/l,h=c/l;let p=1-l/i,u=2+9*p;return{kx:f*u,ky:h*u*.6,scare:p}}function he(s,t,e,r=360){let i=null,o=r;for(let n of e){if(n.eaten)continue;let c=Math.hypot(n.x-s,n.y-t);c<o&&(o=c,i=n)}return i}function de(s,t,e=6,r=Math.random){let i=["#f59e0b","#fbbf24","#fb923c","#facc15"];return Array.from({length:e},()=>({x:s+(r()-.5)*70,y:t+r()*12,vy:.45+r()*.4,phase:r()*Math.PI*2,r:3.4+r()*2,color:i[Math.floor(r()*i.length)],landedAt:0,eaten:!1}))}function fe(s=42,t=Math.random){let e=["#fde047","#fbbf24","#f59e0b","#fcd34d"];return Array.from({length:s},()=>({x:60+t()*904,r:3+t()*6,speed:70+t()*110,delay:t()*2.6,phase:t()*Math.PI*2,color:e[Math.floor(t()*e.length)]}))}function pe(s){let t=Math.max(0,Math.min(1,s/900)),e=2.2;return 1+(e+1)*Math.pow(t-1,3)+e*Math.pow(t-1,2)}function ue(s){let t=kt-1400;return s<=t?1:Math.max(0,1-(s-t)/1400)}function _e(s,t,e=20){if(!s||!t||t.state===void 0)return!1;let r=String(s).split(".")[0],i=String(t.state);if(r==="sun")return i==="below_horizon";if(r==="binary_sensor"||r==="input_boolean"||r==="switch")return i==="on";if(r==="sensor"){let o=parseFloat(i);return!isNaN(o)&&o<e}return!1}var qe=4.186/3600;function Ct(s,t,e=15){return!(s>0)||!(t>e)?0:s*(t-e)*qe}function me({volumeL:s,energyKwh:t,waterPricePerM3:e,energyPricePerKwh:r}){let i=Math.max(0,s||0)*(Number(e)||0)/1e3,o=Math.max(0,t||0)*(Number(r)||0);return{water:i,energy:o,total:i+o}}function At(s,t="fr"){try{return new Intl.NumberFormat(t,{style:"currency",currency:"EUR"}).format(s)}catch{return`${s.toFixed(2)} \u20AC`}}var Kt={max:{fps:0,flowBubbles:36,celebrationParticles:42,celebrationHighlights:!0,richSurface:!0,deathFilter:!0,nightGlow:!0,doubleRipple:!0},balanced:{fps:30,flowBubbles:24,celebrationParticles:30,celebrationHighlights:!0,richSurface:!0,deathFilter:!0,nightGlow:!0,doubleRipple:!0},light:{fps:20,flowBubbles:12,celebrationParticles:15,celebrationHighlights:!1,richSurface:!1,deathFilter:!1,nightGlow:!1,doubleRipple:!1}};function ge(s){return Kt[s]||Kt.max}function ye(s,t,e){return!e||!t?!0:s-t>=1e3/e-2}function xe(s){return s?Math.max(2,1e3/s/16.66*1.6):2}var St=class extends E{static get properties(){return{_hass:{type:Object},_config:{type:Object},_fishes:{type:Array},_snails:{type:Array},_ancistrus:{type:Object},_shrimp:{type:Object},_crab:{type:Object},_bubbles:{type:Array},_boilingBubbles:{type:Array},_flowBubbles:{type:Array},_food:{type:Array},_ripples:{type:Array},_celebration:{type:Object},_nightProgress:{type:Number}}}static async getConfigElement(){return document.createElement("shower-aquarium-card-editor")}static getStubConfig(t,e){let r=e.find(o=>o.includes("shower")||o.includes("hydrao"))||e[0]||"",i=e.find(o=>o.includes("temperature")&&(o.includes("shower")||o.includes("hydrao")))||"";return{entity:r,temperature_entity:i,title:"",theme:"freshwater",aspect_ratio_width:1024,aspect_ratio_height:600,fish_count:4,target_budget:50,survival_volume:10,temp_boiling_threshold:40,temp_deadly_threshold:45,algae_enabled:!0,algae_delay_hours:12,algae_age:0,fish_speed_multiplier:1.2,fullscreen:!1}}constructor(){super(),this._animationFrameId=null,this._deathProgress=0,this._flow=at(),this._flowIntensity=0,this._food=[],this._ripples=[],this._celebration=null,this._isNight=!1,this._nightProgress=0,this._energyKwh=0,this._flowBubbles=Array.from({length:36},()=>({active:!1,x:512,baseX:512,y:0,vy:2,r:3,phase:0})),this._lastTimestamp=0,this._lastFrameTs=0,this._animTime=0,this._cachedConsumedVolume=0,this._cachedTemperature=0,this._cachedTargetBudget=50,this._cachedSurvivalVolume=10,this._cachedHoursSinceLastShower=0,this._fishes=vt(4,"freshwater"),this._snails=[{x:340,y:590,vx:.08,vy:0,dir:1,type:"bottom",color:"#854d0e"},{x:18,y:340,vx:0,vy:.07,dir:1,type:"glass_left",color:"#a16207"},{x:1006,y:220,vx:0,vy:-.06,dir:-1,type:"glass_right",color:"#78350f"}],this._ancistrus={x:70,y:340,targetY:340,state:"idle",idleUntil:0,deathProgress:0},this._shrimp={x:840,y:550,targetX:840,state:"idle",idleUntil:0,dir:-1,deathProgress:0},this._crab={x:350,y:555,targetX:350,state:"idle",idleUntil:0,dir:1,deathProgress:0},this._bubbles=[{x:180,y:560,vy:.9,r:4.5},{x:210,y:580,vy:1.1,r:3.5},{x:512,y:570,vy:.8,r:5},{x:820,y:580,vy:1,r:4},{x:845,y:550,vy:1.2,r:3}],this._boilingBubbles=Array.from({length:24},()=>({x:10+Math.random()*1004,y:30+Math.random()*540,vy:2.5+Math.random()*3.5,vx:(Math.random()-.5)*1.5,r:4+Math.random()*8}))}static get styles(){return Wt}_t(t){return C(V(this._hass),t)}_getCanvasHeight(){return Jt(this._config)}_updateCachedMetrics(){if(!this._hass||!this._config)return;let t=te(this._hass,this._config);this._cachedConsumedVolume=t.consumedVolume,this._cachedHoursSinceLastShower=t.hoursSinceLastShower,this._cachedTemperature=t.temperature,this._cachedTargetBudget=t.targetBudget,this._cachedSurvivalVolume=t.survivalVolume,this._isNight=_e(this._config.night_entity,this._hass.states?.[this._config.night_entity],Number(this._config.night_lux_threshold)||20)}setConfig(t){if(!t.entity)throw new Error("Please define a valid entity.");this._config={title:"",theme:"freshwater",aspect_ratio_width:1024,aspect_ratio_height:600,fish_count:4,target_budget:50,survival_volume:10,temp_boiling_threshold:40,temp_deadly_threshold:45,algae_enabled:!0,algae_delay_hours:12,algae_age:0,fish_speed_multiplier:1.2,fullscreen:!1,night_lux_threshold:20,show_cost:!1,water_price_per_m3:4.5,energy_price_per_kwh:.25,cold_water_temp:15,animation_quality:"max",...t},this._config.fullscreen?this.setAttribute("fullscreen",""):this.removeAttribute("fullscreen");let e=this._config.theme||"freshwater",r=Number(this._config.fish_count)||4;this._fishes=vt(r,e),this._flow=at(),this._food=[],this._celebration=null,this._updateCachedMetrics(),this.requestUpdate()}set hass(t){this._hass=t,this._updateCachedMetrics(),this._trackFlow()}_trackFlow(){if(!this._hass||!this._config)return;let t=this._hass.states?.[this._config.entity]?.state;if(t===void 0||isNaN(parseFloat(t)))return;let e=this._cachedConsumedVolume,r=this._flow.lastVolume,i=Number.isFinite(Number(this._config.cold_water_temp))?Number(this._config.cold_water_temp):15;r===null||e<r-1e-6?this._energyKwh=Ct(e,this._cachedTemperature,i):e>r+1e-6&&(this._energyKwh+=Ct(e-r,this._cachedTemperature,i)),this._flow=re(this._flow,e,Date.now())}connectedCallback(){super.connectedCallback(),this._startAnimation()}disconnectedCallback(){super.disconnectedCallback(),this._stopAnimation()}get _profile(){return ge(this._config?.animation_quality)}_startAnimation(){if(!this._animationFrameId){let t=e=>{ye(e,this._lastFrameTs,this._profile.fps)&&(this._lastFrameTs=e,this._updatePhysics(e)),this._animationFrameId=requestAnimationFrame(t)};this._animationFrameId=requestAnimationFrame(t)}}_stopAnimation(){this._animationFrameId&&(cancelAnimationFrame(this._animationFrameId),this._animationFrameId=null)}_updatePhysics(t){this._lastTimestamp||(this._lastTimestamp=t);let e=t-this._lastTimestamp,r=this._profile,i=Math.min(e/16.66,xe(r.fps));this._lastTimestamp=t,this._animTime=t*.0035;let o={consumedVolume:this._cachedConsumedVolume,temperature:this._cachedTemperature,targetBudget:this._cachedTargetBudget,survivalVolume:this._cachedSurvivalVolume},{tankTop:n,tankBottom:c,waterSurfaceY:l,waterRatio:f,isDead:h,isBoiling:p,speedMultiplier:u}=ot({config:this._config,metrics:o,canvasHeight:this._getCanvasHeight()}),m=Number(this._config.fish_speed_multiplier)||1.2,g=(e||16.66)/4500,w=this._config.theme||"freshwater",_=!1;this._deathProgress=h?Math.min(1,(this._deathProgress||0)+g):0;let v=Date.now(),M=this._isNight?1:0;this._nightProgress!==M&&(this._nightProgress+=(M-this._nightProgress)*Math.min(1,.04*i),Math.abs(M-this._nightProgress)<.005&&(this._nightProgress=M),_=!0);let k=h?0:se(this._flow,v);this._flowIntensity+=(k-this._flowIntensity)*Math.min(1,.03*i),this._flowIntensity<.005&&k===0&&(this._flowIntensity=0),oe(this._flow,v)&&(ae(o.consumedVolume,o.targetBudget,h)&&(this._celebration={start:v,particles:fe(r.celebrationParticles)}),this._flow={...this._flow,showerActive:!1}),this._celebration&&((h||v-this._celebration.start>=kt)&&(this._celebration=null),_=!0),this._ripples.length>0&&(this._ripples=this._ripples.filter(a=>v-a.born<Mt),_=!0),h||f<=0?this._food=[]:this._food.length>0&&(this._food.forEach(a=>{a.landedAt||(a.y+=a.vy*i,a.x+=Math.sin(this._animTime*1.5+a.phase)*.25*i,a.y<l&&(a.y=l),a.y>=c-30&&(a.y=c-30,a.landedAt=v))}),this._food=this._food.filter(a=>!a.eaten&&!(a.landedAt&&v-a.landedAt>6e3)),_=!0);let L=f>0&&!h?ne(this._flowIntensity,r.flowBubbles):0;if(this._flowBubbles.forEach((a,$)=>{if(!a.active){$<L&&(a.active=!0,a.baseX=512+(Math.random()-.5)*90,a.x=a.baseX,a.y=c-10-Math.random()*40,a.vy=1.8+Math.random()*2.2+this._flowIntensity*1.2,a.r=2+Math.random()*4,a.phase=Math.random()*Math.PI*2);return}a.y-=a.vy*i,a.x=a.baseX+Math.sin(this._animTime*2+a.phase)*6,(a.y<l+2||h)&&(a.active=!1),_=!0}),this._flowIntensity>0&&(_=!0),this._fishes&&this._fishes.length>0&&this._fishes.forEach(a=>{if(h){a.deathProgress=Math.min(1,(a.deathProgress||0)+g),a.y=Math.min(c-30,a.y+1.2*i),_=!0;return}a.deathProgress=0;let $=w==="saltwater"&&a.species===0,x=a.scare>.05?null:he(a.x,a.y,this._food);x?(a._baseVy===void 0&&(a._baseVy=a.vy),Math.abs(x.x-a.x)>6&&(a.dir=x.x<a.x?-1:1),a.vy=Math.max(-1.1,Math.min(1.1,(x.y-a.y)*.02)),a._seeking=!0):a._seeking&&(a._baseVy!==void 0&&(a.vy=a._baseVy),a._seeking=!1);let A=x?1.8:1,B=$?Math.max(n+45,l+35,c-160):Math.max(n+45,l+35),q=c-45,J=$?160:110,tt=$?380:910;if(a.x+=a.vx*a.dir*u*A*i,a.y+=a.vy*u*i,a.kickX||a.kickY){a.x+=a.kickX*i,a.y+=a.kickY*i;let P=Math.pow(.93,i);a.kickX*=P,a.kickY*=P;let y=Math.hypot(a.kickX,a.kickY);a.scare=Math.min(1,y/8),y<.15&&(a.kickX=0,a.kickY=0,a.scare=0)}if(this._food.length>0){let P=a.x+a.dir*22*(a.scale||1.4);this._food.forEach(y=>{!y.eaten&&Math.hypot(y.x-P,y.y-a.y)<28&&(y.eaten=!0)})}a.x<J?(a.x=J,a.dir=1):a.x>tt&&(a.x=tt,a.dir=-1),a.y<B?(a.y=B,a.vy=Math.abs(a.vy)):a.y>q&&(a.y=q,a.vy=-Math.abs(a.vy)),_=!0}),this._snails&&this._snails.length>0&&this._snails.forEach(a=>{if(h){a.y=Math.min(c-10,a.y+1.5*i),_=!0;return}if(a.type==="bottom")a.x+=a.vx*a.dir*i,a.x<100?(a.x=100,a.dir=1):a.x>920&&(a.x=920,a.dir=-1);else if(a.type==="glass_left"||a.type==="glass_right"){let $=Math.max(n+35,l+25);a.y+=a.vy*i,a.y<$?(a.y=$,a.vy=Math.abs(a.vy)):a.y>c-25&&(a.y=c-25,a.vy=-Math.abs(a.vy))}_=!0}),this._ancistrus)if(h)this._ancistrus.deathProgress=Math.min(1,(this._ancistrus.deathProgress||0)+g),this._ancistrus.y=Math.min(c-35,this._ancistrus.y+1.2*i),_=!0;else{this._ancistrus.deathProgress=0;let a=Math.max(n+65,l+70),$=c-110;if(this._ancistrus.idleUntil||(this._ancistrus.idleUntil=t+2500+Math.random()*4e3),this._ancistrus.state==="moving"){let x=this._ancistrus.targetY-this._ancistrus.y,A=Math.sign(x)*Math.min(Math.abs(x),.7*m*i);this._ancistrus.y+=A,Math.abs(this._ancistrus.targetY-this._ancistrus.y)<1.5&&(this._ancistrus.state="idle",this._ancistrus.idleUntil=t+3e3+Math.random()*4e3)}else t>=this._ancistrus.idleUntil&&(this._ancistrus.state="moving",this._ancistrus.targetY=a+Math.random()*($-a));_=!0}if(this._shrimp)if(h)this._shrimp.deathProgress=Math.min(1,(this._shrimp.deathProgress||0)+g),_=!0;else{this._shrimp.deathProgress=0,this._shrimp.y=c-25;let a=740,$=940;if(this._shrimp.idleUntil||(this._shrimp.idleUntil=t+1200+Math.random()*2e3),this._shrimp.state==="moving"){let x=this._shrimp.targetX-this._shrimp.x;this._shrimp.dir=x<0?-1:1;let A=Math.sign(x)*Math.min(Math.abs(x),.9*m*i);this._shrimp.x+=A,Math.abs(this._shrimp.targetX-this._shrimp.x)<1.5&&(this._shrimp.state="idle",this._shrimp.idleUntil=t+1500+Math.random()*2500)}else t>=this._shrimp.idleUntil&&(this._shrimp.state="moving",this._shrimp.targetX=a+Math.random()*($-a));_=!0}if(this._crab)if(h)this._crab.deathProgress=Math.min(1,(this._crab.deathProgress||0)+g),_=!0;else{this._crab.deathProgress=0,this._crab.y=c-20;let a=240,$=460;if(this._crab.idleUntil||(this._crab.idleUntil=t+2e3+Math.random()*3e3),this._crab.state==="moving"){let x=this._crab.targetX-this._crab.x;this._crab.dir=x<0?-1:1;let A=Math.sign(x)*Math.min(Math.abs(x),.7*m*i);this._crab.x+=A,Math.abs(this._crab.targetX-this._crab.x)<1.5&&(this._crab.state="idle",this._crab.idleUntil=t+2500+Math.random()*3500)}else t>=this._crab.idleUntil&&(this._crab.state="moving",this._crab.targetX=a+Math.random()*($-a));_=!0}f>0&&!h&&this._bubbles&&this._bubbles.forEach(a=>{a.y-=a.vy*i,a.y<l&&(a.y=c-15),_=!0}),p&&f>0&&this._boilingBubbles&&this._boilingBubbles.forEach(a=>{a.y-=a.vy*i,a.x+=a.vx*i,a.y<l&&(a.y=c-15,a.x=10+Math.random()*1004),_=!0}),_&&this.requestUpdate()}_renderWaterSurface(t,e,r){let i=this._flowIntensity||0,o=3.5+i*6.5,n=90-i*35,c=this._animTime*(1.6+i*2.4),l=this._profile.richSurface,f=l?16:28,h=_=>l?Math.sin(_/17+c*2.3)*i*2.4:0,p=[],u=[];for(let _=t;_<e;_+=f)p.push([_,r+Math.sin(_/n+c)*o+h(_)]),u.push([_,r+4+Math.sin(_/n+c+.6)*o*.7]);p.push([e,r+Math.sin(e/n+c)*o+h(e)]),u.push([e,r+4+Math.sin(e/n+c+.6)*o*.7]);let m=_=>`${_[0].toFixed(1)},${_[1].toFixed(1)}`,g=p.map(m).join(" L "),w=u.slice().reverse().map(m).join(" L ");return d`
      <path d="M ${g} L ${w} Z" fill="#ffffff" opacity="0.25" />
      <path d="M ${g}" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-opacity="0.85" stroke-linecap="round" />
    `}_renderAnemoneTentacles(t=0){let e=[{count:11,baseR:20,lenMin:60,lenMax:95,spread:160,width:5,color:"#a21caf",tip:"#f0abfc",speed:.55},{count:16,baseR:22,lenMin:50,lenMax:88,spread:190,width:6.5,color:"#c026d3",tip:"#f5d0fe",speed:.68}],r=[];return e.forEach((i,o)=>{for(let n=0;n<i.count;n++){let c=n/(i.count-1),l=-90-i.spread/2+c*i.spread,f=(i.lenMin+(i.lenMax-i.lenMin)*(.5+.5*Math.sin(c*Math.PI)))*(1-.3*t),h=o*10+n*.7,p=Math.sin(this._animTime*i.speed+h)*9*(1-t),u=l*Math.PI/180,m=Math.cos(u)*i.baseR,g=Math.sin(u)*i.baseR,w=n*37%17-8,_=l+90+p;r.push(d`
          <g transform="translate(${m.toFixed(1)}, ${g.toFixed(1)}) rotate(${_.toFixed(1)})">
            <path d="M 0,0 Q ${w.toFixed(1)},${(-f*.55).toFixed(1)} 0,${(-f).toFixed(1)}" stroke="${i.color}" stroke-width="${i.width}" stroke-linecap="round" fill="none" opacity="0.9" />
    ...
    `}_renderFishShape(t,e,r){let i=t.dir===-1,o=t.deathProgress||0,n=t.scale||1.4,c=(1-o).toFixed(2),l=o.toFixed(2),f=r?0:t.scare||0,h=r?0:Math.sin(this._animTime*(3.5*t.vx)+t.phase)*14*(1+.8*f),p=r?0:Math.sin(this._animTime*(4.5*t.vx)+t.phase)*10,u;return e==="saltwater"?t.species===0?u=d`
    ...
    `}_renderAncistrus(t){if(!this._ancistrus)return d``;let e=this._ancistrus,r=e.deathProgress||0,i=(1-r).toFixed(2),o=t?1:(1+Math.sin(this._animTime*1.6)*.07).toFixed(3),n="#182026",c="#1e293b",l="#0a0f14",f="#475569";return d`
    ...
    `}_renderCelebration(t,e,r){let i=this._celebration;if(!i)return d``;let o=Date.now()-i.start,n=ue(o).toFixed(2),c=pe(o),l=(e+r)/2,f=o/1e3,h=Math.min(t,r-60);return d`
      <g id="celebration" opacity="${n}" pointer-events="none">
        ${i.particles.map(p=>{let u=f-p.delay;if(u<=0)return d``;let m=r-12-u*p.speed;if(m<h)return d``;let g=p.x+Math.sin(f*2+p.phase)*12;return d`
            <circle cx="${g.toFixed(1)}" cy="${m.toFixed(1)}" r="${p.r.toFixed(1)}" fill="${p.color}" fill-opacity="0.85" stroke="#ffffff" stroke-opacity="0.8" stroke-width="1" />
            ${this._profile.celebrationHighlights?d`<circle cx="${(g-p.r*.3).toFixed(1)}" cy="${(m-p.r*.3).toFixed(1)}" r="${(p.r*.28).toFixed(1)}" fill="#ffffff" fill-opacity="0.9" />`:""}
          `})}
    ...
    `}_renderStatusPanel(t,e,r,i,o){let c=2*Math.PI*74,l=9,f=102,{tempFraction:h,tempColor:p,volFraction:u,volColor:m}=ee({currentTemp:t,currentVolume:e,targetBudget:r,deadlyTemp:i,boilTemp:o}),g=102,w=t>0,_=(h*c).toFixed(1),v=922,M=(u*c).toFixed(1);return d`
      <!-- Left Gauge: Water Temperature -->
      ${w?d`
            <g transform="translate(${g}, ${f})">
              ...
              <circle
                ...
                stroke-dasharray="${_} ${c.toFixed(1)}"
                transform="rotate(-90)"
              />
          ...
          >
            <defs>
              ...
              <linearGradient id="waterGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stop-color="${a}" stop-opacity="${w?"0.5":"0.25"}" />
                <stop offset="100%" stop-color="${$}" stop-opacity="${w?"0.75":"0.45"}" />
              </linearGradient>
            ...
            <g clip-path="url(#innerTankClip)">
              ...
              <g>
                ${this._snails.map((y,we)=>{let ve=y.type==="glass_left"?90:y.type==="glass_right"?-90:0,Et=k==="saltwater"?we%2===0?3.5:4.2:1.8;return d`
                    <g transform="translate(${y.x}, ${y.y}) rotate(${g?0:ve}) scale(${y.dir*Et},${Et})">
                      <circle cx="-3" cy="-4" r="5.5" fill="${y.color}" />
              ...
              ${h>0&&!g?d`
                    <g>
                      ${this._bubbles.map(y=>d`
                          <circle cx="${y.x}" cy="${y.y}" r="${y.r}" fill="#ffffff" opacity="0.6" stroke="rgba(255,255,255,0.8)" stroke-width="0.8" />
                        `)}
                    </g>
                  `:""}

              ${h>0&&!g?this._renderFlowBubbles():""}
              ${this._renderFood()}

              ${w&&h>0?d`
                    <g>
                      ${this._boilingBubbles.map(y=>d`
                          <circle cx="${y.x}" cy="${y.y}" r="${y.r}" fill="#fef08a" opacity="0.75" stroke="#ffffff" stroke-width="1.2" />
                        `)}
                    </g>
                  `:""}

              <g>
                ${(this._fishes||[]).map(y=>d`
                    <g transform="translate(${y.x},${y.y})">
                      ${this._renderFishShape(y,k,g)}
                    </g>
                  `)}
              </g>
              ...
              ${t?this._renderCostPill(P,600):""}

              ${this._renderNightOverlay(t?600:e,p)}
              ${this._renderCelebration(m,p,u)}
            </g>
    ...
    `}getCardSize(){return 6}};customElements.get("shower-aquarium-card")||customElements.define("shower-aquarium-card",St);console.info(`%c SHOWER-AQUARIUM-CARD %c v${xt} `,"color: white; background: #0284c7; font-weight: 700; border-radius: 3px 0 0 3px; padding: 2px 6px;","color: #0284c7; background: #e0f2fe; font-weight: 700; border-radius: 0 3px 3px 0; padding: 2px 6px;");window.customCards=window.customCards||[];var $e=window.customCards.findIndex(s=>s.type==="shower-aquarium-card"),be={type:"shower-aquarium-card",name:"Shower Aquarium Card",preview:!0,description:`An animated aquarium dashboard card reflecting shower water usage. (v${xt})`};$e!==-1?window.customCards[$e]=be:window.customCards.push(be);
